...
public class TopicManagerImpl implements TopicManager {
    ...
    public Subscription_check subscribe(Topic topic, Subscriber subscriber) {
        Publisher publisher = topicMap.get(topic);
        if (!isTopic(topic).isOpen) {
            Subscription_check sub_check = new Subscription_check(topic, Result.NO_TOPIC);
            return sub_check;
        }
        Subscription_check sub_check = new Subscription_check(topic, Result.OKAY);
    ...
    public Subscription_check unsubscribe(Topic topic, Subscriber subscriber) {
        ...
        Subscription_check sub_check = new Subscription_check(topic, Result.NO_SUBSCRIPTION);
        return sub_check;
    }
